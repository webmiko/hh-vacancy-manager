"""Модуль для поиска и анализа транзакций.

Этот модуль содержит функции для поиска транзакций по различным критериям
и расчета аналитических показателей.
"""
...
def _setup_logger() -> logging.Logger:
    """
    Настраивает и возвращает логгер для модуля transaction_search.

    Returns:
        Настроенный логгер для модуля transaction_search
    """
    ...
    log_file = logs_dir / "transaction_search.log"
