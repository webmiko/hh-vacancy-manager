"""Модуль для анализа трат и генерации отчетов.
...
def _setup_logger() -> logging.Logger:
    """
    Настраивает и возвращает логгер для модуля spending_analysis.

    Returns:
        Настроенный логгер для модуля spending_analysis
    """
    ...
    log_file = logs_dir / "spending_analysis.log"
...
def spending_by_category(transactions: pd.DataFrame, category: str, date: Optional[str] = None) -> pd.DataFrame:
    ...
    try:
        # Импорт функции из date_operations
        from .date_operations import get_three_months_back
